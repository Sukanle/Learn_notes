...
void setCursorPos(GLFWwindow *window, double xpos, double ypos) noexcept;
void setScroll(GLFWwindow *ctx, double xoffset, double yoffset) noexcept;
...
int main() {
    ...
    GLFWwindow *ctx = glfwCreateWindow(WIDTH, HEIGHT, "camera_mouse_zoom", nullptr, nullptr);
...
void setCursorPos(GLFWwindow *ctx, double in_xpos, double in_ypos) noexcept {
    float xpos = in_xpos;
    float ypos = in_ypos;
    ...
    pitch = fminf(pitch, 89.0F);
    pitch = fmaxf(pitch, -89.0F);
